...
#ifndef LOCAL_PLAYER_SDK_MEDIAPLAYER_INCLUDE_MEDIAPLAYER_URLSOURCE_H_
#define LOCAL_PLAYER_SDK_MEDIAPLAYER_INCLUDE_MEDIAPLAYER_URLSOURCE_H_
...
public:
    ...
    static std::shared_ptr<UrlSource> create(
        ...
        std::shared_ptr<rkpCommon::utils::playlistParser::PlaylistParserInterface> playlistParser,
    ...
    void onPlaylistEntryParsed(
        ...
        std::chrono::milliseconds duration =
            rkpCommon::utils::playlistParser::PlaylistParserObserverInterface::INVALID_DURATION) override;
...
private:
    ...
    /// A Playlist Parser.
    std::shared_ptr<rkpCommon::utils::playlistParser::PlaylistParserInterface> m_playlistParser;
...
#endif  // LOCAL_PLAYER_SDK_MEDIAPLAYER_INCLUDE_MEDIAPLAYER_URLSOURCE_H_
