...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_TEST_RKPCOMMON_UTILS_MEDIAPLAYER_MOCKMEDIAPLAYER_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_TEST_RKPCOMMON_UTILS_MEDIAPLAYER_MOCKMEDIAPLAYER_H_
...
public:
    ...
    void setObserver(
        std::shared_ptr<rkpCommon::utils::mediaPlayer::MediaPlayerObserverInterface> playerObserver) /*override*/;

    SourceId setSource(std::shared_ptr<rkpCommon::rkp::attachment::AttachmentReader> attachmentReader) /*override*/;
    MOCK_METHOD1(
        attachmentSetSource,
        SourceId(std::shared_ptr<rkpCommon::rkp::attachment::AttachmentReader> attachmentReader));
    SourceId setSource(
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_TEST_RKPCOMMON_UTILS_MEDIAPLAYER_MOCKMEDIAPLAYER_H_
