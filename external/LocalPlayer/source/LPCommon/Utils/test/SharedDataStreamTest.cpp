...
struct MinimalTraits {
    ...
    static constexpr const char* traitsName = "localPlayerSDK::rkpCommon::utils::sds::test::MinimalTraits";
};
...
struct MinimalTraits2 {
    ...
    static constexpr const char* traitsName = "localPlayerSDK::rkpCommon::utils::sds::test::MinimalTraits2";
};
