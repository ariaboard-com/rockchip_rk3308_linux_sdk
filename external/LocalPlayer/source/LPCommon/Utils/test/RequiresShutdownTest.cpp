...
class Object : public localPlayerSDK::rkpCommon::utils::RequiresShutdown {
public:
    /**
     * Constructor.
     *
     ...
     */
    Object(const std::string& name) : localPlayerSDK::rkpCommon::utils::RequiresShutdown(name), properShutdown{true} {
    }
