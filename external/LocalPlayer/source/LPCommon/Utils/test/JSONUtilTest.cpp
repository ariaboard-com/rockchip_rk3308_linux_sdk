...
/// An invalid RKP directive JSON.``
static const std::string EMPTY_DIRECTIVE = R"({
            "directive": {
                          }
        })";

/// A sample RKP speak directive with all valid JSON keys.
// clang-format off
...
/// Define test fixture for testing RKPMessage.
