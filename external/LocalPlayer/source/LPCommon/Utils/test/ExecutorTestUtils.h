...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_TEST_EXECUTORTESTUTILS_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_TEST_EXECUTORTESTUTILS_H_
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_TEST_EXECUTORTESTUTILS_H_
