...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_LOGGER_LOGGER_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_LOGGER_LOGGER_H_
...
#include "LPCommon/Utils/Logger/LogEntry.h"
#include "LPCommon/Utils/Logger/LogLevelObserverInterface.h"
#include "LPCommon/Utils/Logger/SinkObserverInterface.h"
...
#include "LPCommon/Utils/Logger/ModuleLogger.h"
...
#define ACSDK_LOG(level, entry)                                                                       \
    do {                                                                                              \
        auto& loggerInstance = localPlayerSDK::rkpCommon::utils::logger::ACSDK_GET_LOGGER_FUNCTION(); \
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG9(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG9, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG8(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG8, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG7(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG7, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG6(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG6, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG5(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG5, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG4(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG4, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG3(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG3, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG2(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG2, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG1(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG1, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG0(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG0, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_DEBUG(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::DEBUG0, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_INFO(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::INFO, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_WARN(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::WARN, entry)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_ERROR(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::ERROR, entry)
/**
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define ACSDK_CRITICAL(entry) ACSDK_LOG(localPlayerSDK::rkpCommon::utils::logger::Level::CRITICAL, entry)

#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_LOGGER_LOGGER_H_
