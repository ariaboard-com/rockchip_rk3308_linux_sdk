...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_METRICS_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_METRICS_H_
...
public:
    ...
    static logger::LogEntry& d(
        localPlayerSDK::rkpCommon::utils::logger::LogEntry& logEntry,
     ...
     * @param logEntry The @c LogEntry object to add the metric info.
     * @param msg The @c RKPMessage related to this metric
     * @param location The location in which the log was issued.
     * @return The given @c LogEntry with the metric info added.
     */
    static logger::LogEntry& d(
        localPlayerSDK::rkpCommon::utils::logger::LogEntry& logEntry,
        const std::shared_ptr<localPlayerSDK::rkpCommon::rkp::RKPMessage> msg,
        Location location);
...
#define ACSDK_METRIC_IDS(TAG, name, messageId, dialogRequestId, location)                                   \
    do {                                                                                                    \
        localPlayerSDK::rkpCommon::utils::logger::LogEntry logEntry(                                        \
            TAG, __func__ + localPlayerSDK::rkpCommon::utils::METRICS_TAG);                                 \
        localPlayerSDK::rkpCommon::utils::Metrics::d(logEntry, name, messageId, dialogRequestId, location); \
...
#define ACSDK_METRIC_MSG(TAG, msg, location)                                   \
    do {                                                                       \
        localPlayerSDK::rkpCommon::utils::logger::LogEntry logEntry(           \
            TAG, __func__ + localPlayerSDK::rkpCommon::utils::METRICS_TAG);    \
        localPlayerSDK::rkpCommon::utils::Metrics::d(logEntry, msg, location); \
        ACSDK_METRIC_WITH_ENTRY(logEntry);                                     \
    } while (false)
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_METRICS_H_
