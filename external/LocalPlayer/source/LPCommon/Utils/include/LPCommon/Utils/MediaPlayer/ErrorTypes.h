...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_MEDIAPLAYER_ERRORTYPES_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_MEDIAPLAYER_ERRORTYPES_H_
...
/**
 * Convert an @c ErrorType to an RKP-compliant @c std::string.
 *
 * @param errorType The @c ErrorType to convert.
 * @return The RKP-compliant string representation of @c errorType.
 */
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_MEDIAPLAYER_ERRORTYPES_H_
