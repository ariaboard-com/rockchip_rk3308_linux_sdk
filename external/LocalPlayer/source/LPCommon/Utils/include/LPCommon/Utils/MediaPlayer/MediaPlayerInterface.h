...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_MEDIAPLAYER_MEDIAPLAYERINTERFACE_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_MEDIAPLAYER_MEDIAPLAYERINTERFACE_H_
...
public:
     ...
     */
    virtual SourceId setSource(std::shared_ptr<rkpCommon::rkp::attachment::AttachmentReader> attachmentReader) = 0;
    ...
    virtual void setObserver(
        std::shared_ptr<rkpCommon::utils::mediaPlayer::MediaPlayerObserverInterface> playerObserver) = 0;
};
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_UTILS_INCLUDE_RKPCOMMON_UTILS_MEDIAPLAYER_MEDIAPLAYERINTERFACE_H_
