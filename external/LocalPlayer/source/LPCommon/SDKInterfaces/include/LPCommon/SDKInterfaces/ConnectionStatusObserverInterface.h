...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_CONNECTIONSTATUSOBSERVERINTERFACE_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_CONNECTIONSTATUSOBSERVERINTERFACE_H_
...
/**
 * This class allows a client to be notified of changes to connection status to RKP.
 */
class ConnectionStatusObserverInterface {
public:
    /**
     * This enum expresses the states that a logical RKP connection can be in.
     */
    enum class Status {
        /// ACL is not connected to RKP.
        DISCONNECTED,

        /// ACL is attempting to establish a connection to RKP.
        PENDING,

        /// ACL is connected to RKP.
        CONNECTED
    };
    ...
    enum class ChangedReason {
        ...
        /// There was a timeout writing to RKP.
        WRITE_TIMEDOUT,

        /// There was a timeout reading from RKP.
        READ_TIMEDOUT,
    ...
    /**
     * Called when the RKP connection state changes.
     *
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_CONNECTIONSTATUSOBSERVERINTERFACE_H_
