...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_SPEAKERMANAGEROBSERVERINTERFACE_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_SPEAKERMANAGEROBSERVERINTERFACE_H_
...
public:
    /// Indicates whether the source of the call is from an RKP Directive or through a Local API call.
    enum class Source {
        // The call occured as a result of an RKP Directive.
        DIRECTIVE,
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_SPEAKERMANAGEROBSERVERINTERFACE_H_
