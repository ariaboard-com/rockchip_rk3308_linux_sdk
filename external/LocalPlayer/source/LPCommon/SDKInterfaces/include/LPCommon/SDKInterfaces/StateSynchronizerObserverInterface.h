/*
 * StateSynchronizerObserverInterface.h
 *
...
#ifndef LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_STATESYNCHRONIZEROBSERVERINTERFACE_H_
#define LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_STATESYNCHRONIZEROBSERVERINTERFACE_H_
 ...
 * event should be the first message sent to RKP upon connection, if a component is sending a message, then it needs to
...
#endif  // LOCAL_PLAYER_SDK_RKPCOMMON_SDKINTERFACES_INCLUDE_RKPCOMMON_SDKINTERFACES_STATESYNCHRONIZEROBSERVERINTERFACE_H_
